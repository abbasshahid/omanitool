...
export default function SplitPDFPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      // Sort selected pages to maintain document order
                ...
                {!isDone && (
                   <div className="space-y-4">
                      ...
                      <div className="relative border border-[var(--color-border-base)] rounded-xl bg-gray-50/50 dark:bg-gray-800/20 p-6 min-h-[300px]">
                         {/* Render Page 1 to trigger onLoad and get total pages, but hide it if we are mapping all pages manually later.
                             Wait, PDFThumbnail component calls onLoad(pdf.numPages). We can just render Page 1 first.
                             Actually, better to map after we know numPages. If numPages is 0, render a single hidden one to get the count. */}
                         {numPages === 0 && (
