              ...
              <div className="space-y-6">
                ...
                {!isDone ? (
                  ...
                  <div className="pt-6 border-t border-[var(--color-border-base)] flex flex-col items-center justify-center p-8 bg-emerald-500/5 border border-emerald-500/20 rounded-xl text-center">
                    ...
                    <p className="text-[var(--color-text-muted)] mb-6 max-w-sm">Your PDF has been successfully converted to an editable Word document.</p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                       ...
                       {downloadUrl && (
                         <a href={downloadUrl} download={file.name.replace('.pdf', '.docx')} className="btn-primary bg-emerald-600 hover:bg-emerald-500 ring-emerald-600 shadow-lg shadow-emerald-500/20 px-8 py-3 rounded-xl gap-2 font-bold text-white flex items-center justify-center">
