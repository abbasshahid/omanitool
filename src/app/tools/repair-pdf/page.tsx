                 ...
                 <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4 flex gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-amber-700 dark:text-amber-400/80 mt-1">
                       Repairing corrupted or damaged PDFs requires advanced low-level file format analysis and reconstruction. Client-side libraries cannot reliably read corrupted structures. This feature necessitates a specialized backend API like Ghostscript or Mutool.
                     </p>
                   </div>
                 </div>
              ...
              <div className="space-y-6">
                ...
                {!isDone ? (
                  ...
                  <div className="pt-6 border-t border-[var(--color-border-base)] flex flex-col items-center justify-center p-8 bg-amber-500/5 border border-amber-500/20 rounded-xl text-center">
                    ...
                    <h3 className="text-xl font-bold text-[var(--color-text-main)] mb-2">Simulated Repair Processing</h3>
                    <p className="text-[var(--color-text-muted)] mb-6 max-w-sm">This is a UI prototype. True PDF repair capabilities require an active backend server connection.</p>
