                 ...
                 <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4 flex gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-amber-700 dark:text-amber-400/80 mt-1">
                       Translating PDF documents while preserving their exact visual layout requires a backend server to extract text, call translation APIs (like Google Cloud Translation), and rebuild the PDF structure.
                     </p>
                   </div>
                 </div>
