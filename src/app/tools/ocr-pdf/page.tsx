...
// --------------------------------------------------------------------------
// Fix PDF.js worker for Next.js
// Next.js handles this import by copying it to the static output
// --------------------------------------------------------------------------
...
export default function OCRPDFPage() {
  ...
  const handleProcess = async () => {
    ...
    try {
      // 1. Convert PDF to Image(s) if necessary
      const images: string[] = [];
      ...
      if (file.type === 'application/pdf') {
         ...
         const numPages = Math.min(pdf.numPages, 5); // Limit to 5 pages for browser performance
      ...
      setProgress({ status: 'Loading OCR Engine (English)...', progress: 0.35 });
      
      // Simulate progress for the UX since tesseract v7's logger option causes cloning errors in strictly-isolated environments
