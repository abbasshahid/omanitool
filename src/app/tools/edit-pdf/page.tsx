                 ...
                 <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4 flex gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-amber-700 dark:text-amber-400/80 mt-1">
                       Full PDF editing (modifying existing text, replacing images, reflowing paragraphs) is beyond the scope of client-side JavaScript. This requires a robust backend engine like PDFTron or PSPDFKit.
                     </p>
                   </div>
                 </div>
              ...
              <div className="space-y-6">
                ...
                {!isDone ? (
                  ...
                  <div className="pt-6 border-t border-[var(--color-border-base)] flex flex-col items-center justify-center p-8 bg-amber-500/5 border border-amber-500/20 rounded-xl text-center">
                    ...
                    <h3 className="text-xl font-bold text-[var(--color-text-main)] mb-2">Simulated Editing</h3>
                    <p className="text-[var(--color-text-muted)] mb-6 max-w-sm">This is a UI prototype. True PDF document editing requires an active backend server connection.</p>
