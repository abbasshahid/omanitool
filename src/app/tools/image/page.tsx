  ...
  return (
    <div className="container mx-auto max-w-7xl px-4 xl:px-8 py-10 md:py-16">
      ...
      <div className="mb-10 text-center">
        <AdSenseBanner dataAdSlot="IMAGE_HUB_TOP" className="h-[90px] w-full max-w-[728px] mx-auto bg-slate-900/30 rounded-xl" />
      </div>
      ...
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-bold text-[var(--color-text-main)] mb-4">
          Free <span className="text-indigo-500">Image</span> Tools
        </h1>
        <p className="text-xl text-[var(--color-text-muted)] max-w-2xl">
          Resize, compress, and remove backgrounds from images natively without leaving your browser.
        </p>
      </div>
