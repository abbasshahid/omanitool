    ...
    <div ref={containerRef} className="relative w-full">
      ...
      {open && (
        <div
          ...
          role="listbox"
          className="absolute inset-x-0 top-full z-50 mt-2 overflow-hidden rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--surface)] text-left shadow-[var(--shadow-pop)]"
        >
          {!query.trim() && (
            <p className="eyebrow bg-[var(--surface-2)] px-4 py-2">Most used</p>
          )}
