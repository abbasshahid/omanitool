                 ...
                 <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-800/50 rounded-xl p-4 flex gap-3">
                   ...
                   <div>
                     ...
                     <p className="text-sm text-amber-700 dark:text-amber-400/80 mt-1">
                       Repairing corrupted or damaged PDFs requires advanced low-level file format analysis and reconstruction. Client-side libraries cannot reliably read corrupted structures. This feature necessitates a specialized backend API.
                     </p>
                   </div>
                 </div>
