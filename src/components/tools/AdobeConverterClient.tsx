...
interface AdobeConverterClientProps {
  toolId: 'word-to-pdf' | 'powerpoint-to-pdf' | 'excel-to-pdf';
}

export default function AdobeConverterClient({ toolId }: AdobeConverterClientProps) {
  ...
  const acceptedTypes = toolId === 'word-to-pdf' ? '.doc,.docx' : toolId === 'powerpoint-to-pdf' ? '.ppt,.pptx' : '.xls,.xlsx';
              ...
              <div className="space-y-6">
                ...
                {!isDone ? (
                  ...
                  <div className="pt-6 border-t border-[var(--color-border-base)] flex flex-col items-center justify-center p-8 bg-emerald-500/5 border border-emerald-500/20 rounded-xl text-center">
                    ...
                    <p className="text-[var(--color-text-muted)] mb-6 max-w-sm">Your document has been converted to PDF and is ready for download.</p>
